...
void upscaler_example()
{
    ...
    upscaler(arr.data(), new_arr.data(), num_rows, num_columns, num_filters, scale_up_factor);
    ...
    upscaler(arr.data(), new_vec.data(), num_rows, num_columns, num_filters, scale_up_factor);
